...
- Files at `workspace/skills/{name}/SKILL.md` are auto-discovered and injected into worker prompts. To add one, route the user to `/v1/agents/skill_builder` — don't write them yourself.
